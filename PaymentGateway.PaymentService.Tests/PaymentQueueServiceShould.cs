...
{
    public class PaymentQueueServiceShould
    {
        ...
        private readonly PaymentQueueService _service;

        public PaymentQueueServiceShould()
        {
            ...
            _service = new PaymentQueueService(_mockQueueServiceClient.Object, _mockConfiguration.Object, _mockLogger.Object);
        }
        [Fact]
        public async Task SendPaymentAsync_ShouldSendPaymentToQueue_WhenCalled()
        {
            ...
            // Act
            await _service.SendPaymentAsync(paymentDto, CancellationToken.None);
